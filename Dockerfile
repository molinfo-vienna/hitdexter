...
LABEL org.opencontainers.image.source="https://github.com/molinfo-vienna/hitdexter"
...
CMD [ \
    # TODO: remove
    "/bin/sh", "-c", \
    "/env/bin/nerdd_prediction_server hitdexter.HitDexter3Model --broker-url $KAFKA_BROKER_URL --data-dir /data" \
    ]